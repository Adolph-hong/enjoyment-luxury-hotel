...
const HeroTitle = ({ children, leftClassName = '' }) => {
  return (
    <div className="relative flex flex-col justify-center items-center xl:flex-row w-full h-[120vh] xl:h-screen bg-[image:var(--bg-image-hero)] bg-cover bg-center">
      ...
      <div className={`absolute top-35 xl:relative xl:top-0 xl:w-1/2 xl:gap-0 gap-15 z-10 flex flex-col w-full items-center xl:justify-center xl:items-start text-white xl:pl-20 xl:pr-40 xl:mr-[-50px] ${leftClassName}`}>
