    ...
    <section>
      <div className="flex flex-row w-full py-25 xl:h-screen bg-black">
        <div className="bg-image-about bg-no-repeat h-3/4 w-full bg-cover bg-center text-white pl-10 pr-5 xl:px-0">
          <div className="mx-auto xl:w-[60%] xl:mr-40 mt-15 mb-20 p-15 border-l border-b inset-0 z-10 rounded-t-[80px] rounded-bl-[80px]  bg-gradient-to-b from-black to-[#BE9C7CCC] w-[60%] bg-opacity-50">
