const AboutSection = () => {
  return (
    <section>
      <div className="flex flex-row w-full pt-25 h-screen bg-black">
        <div className="relative bg-no-repeat h-3/4  w-full bg-cover bg-center bg-[image:var(--home-bg-about)] text-white">
